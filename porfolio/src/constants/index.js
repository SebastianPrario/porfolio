...
export const projects = [
    {name:'Bon Appetit' , info:'Trabajo final grupal que permite a los clientes pedir a través de una app comidas en un restaurante, con la posibilidad de pagar a través de Mercado Pago', tecno: 'React , Redux , Express , Sequelize , PostgreSQL , FireBase, MercadoPago , Cloudinary',  img:'/src/img/bon.png' , deploy: '//bonappetite.vercel.app/'},
    {name:'Qué comemos hoy?', info:'Esta aplicación de recetas permite busquedas combinadas y crear recetas nuevas.', tecno:'React , Redux , Express , Sequelize , PostgreSQL , Axios' ,  img: '/src/img/food.png', deploy:'//pi-food-pi-hazel.vercel.app/'},
    {name:'Rick and Morty' , info: 'Este proyecto toma la información de una api.Tambien permite logearse y guardar en favoritos.' ,tecno:'React , Redux , Axios, CSS' , img:'/src/img/rick.png', deploy: '//rick-and-morty-ottv-e5cmo13pr-sebastianprario.vercel.app'}
  ]